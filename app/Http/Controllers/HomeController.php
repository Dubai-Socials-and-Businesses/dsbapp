...
//        $endDateTime = $endDate . ' ' . $endTime;
    ...
    public function editGallery(Request $request)
    {
        $validated = $request->validate([
            ...
            'gphotos.*.nimage' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg|max:20480',
            'photos' => 'array',
            'photos.*.title' => 'nullable|string|max:255',
            'photos.*.nimage' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg|max:20480',
